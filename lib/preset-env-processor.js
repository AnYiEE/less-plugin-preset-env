...
module.exports = function (less) {
	function PresetEnvProcessor(options) {
		this.options = options || {};
	}

	PresetEnvProcessor.prototype = {
		process: function (css, extra) {
			...
			var processed = postcss([postcssPresetEnv(options)]).process(css, processOptions);
